...
<body>
    <div><?php
            include("header.php");
            ?></div>
    <div style="text-align: center;"><button id="pdfButton" onclick="makepdf()" style="height: 50px;"><b>Click here to Generate PDF</b></button></div><br>
                    ...
                    <table id="career">
                        <?php while ($data = mysqli_fetch_array($rs_exp)) { ?>
                            <tr>
                                ...
                                <td>
                                    <h3><?php echo $data['excompany']; ?></h3>
                                    <h4><?php echo $data['exdesignation']; ?></h4><?php echo $data['description']; ?>
                                </td>
                            </tr>
                        <?php
                        } ?>
